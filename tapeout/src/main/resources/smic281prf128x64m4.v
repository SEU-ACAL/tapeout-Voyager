...
/*
    ...
    Filename   : smic281prf128x64m4.v
    IP code    : S28HKCPHD1PRF
    Version    : V0P2A
    CreateDate : Jul 1, 2025 9:06:09 AM

    Verilog Model for High Speed One-Port SRAM
    SMIC 28 SFE Process

    Configuration: -instname smic281prf128x64m4 
                   -words 128 -bits 64 -mux 4 -bank 1
...
`endif
  ...
  // PARAMETERS
  //////////////////////////////////////////////
  parameter WORDS        = 128;  // words
  parameter A_WIDTH      = 7;  // address bits
