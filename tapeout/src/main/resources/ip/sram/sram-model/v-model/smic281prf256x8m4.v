...
/*
    ...
    Filename   : smic281prf256x8m4.v
    IP code    : S28HKCPHD1PRF
    Version    : V0P2A
    CreateDate : Jul 11, 2025 11:55:15 AM

    Verilog Model for High Speed One-Port SRAM
    SMIC 28 SFE Process

    Configuration: -instname smic281prf256x8m4 
                   -words 256 -bits 8 -mux 4 -bank 1
