...
//
//       Instance Name:              arm28hkcpdpsram128x8m4
//       Words:                      128
//       Bits:                       8
//       Mux:                        4
//       Drive:                      6
...
//       
//       Creation Date:  Sun Jul 20 14:06:12 2025
//       Version: 	r0p1
//
...
module datapath_latch_arm28hkcpdpsram128x8m4 (CLK,Q_update,D_update,SE,SI,D,DFTRAMBYP,mem_path,XQ,Q);
...
endmodule // datapath_latch_arm28hkcpdpsram128x8m4
...
`ifdef POWER_PINS
module arm28hkcpdpsram128x8m4 (VDDCE, VDDPE, VSSE, CENYA, WENYA, AYA, CENYB, WENYB,
    ...
    SIB, SEB, COLLDISN);
`else
module arm28hkcpdpsram128x8m4 (CENYA, WENYA, AYA, CENYB, WENYB, AYB, GWENYA, GWENYB,
 ...
 wire  CLKB_;
  ...
  assign `ARM_UD_DP GWENYB_ = (RET1N_ | pre_charge_st) ? (DFTRAMBYP_ & (TENB_ ? GWENB_ : TGWENB_)) : 1'bx;
   `ifdef ARM_FAULT_MODELING
     arm28hkcpdpsram128x8m4_error_injection u1(.CLK(CLKA_), .Q_out(QA_), .A(AA_int), .CEN(CENA_int), .DFTRAMBYP(DFTRAMBYP_int), .SE(SEA_int), .GWEN(GWENA_int), .WEN(WENA_int), .Q_in(QA_int));
  `else
...
`endif
  ...
  datapath_latch_arm28hkcpdpsram128x8m4 uDQA0 (.CLK(CLKA), .Q_update(QA_update), .D_update(DA_sh_update), .SE(SEA_), .SI(SIA_int[0]), .D(DA_int_bmux[0]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path_A[0]), .XQ(XQA|partial_corrupt_A[0]), .Q(QA_int[0]));
  datapath_latch_arm28hkcpdpsram128x8m4 uDQA1 (.CLK(CLKA), .Q_update(QA_update), .D_update(DA_sh_update), .SE(SEA_), .SI(QA_int[0]), .D(DA_int_bmux[1]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path_A[1]), .XQ(XQA|partial_corrupt_A[1]), .Q(QA_int[1]));
  datapath_latch_arm28hkcpdpsram128x8m4 uDQA2 (.CLK(CLKA), .Q_update(QA_update), .D_update(DA_sh_update), .SE(SEA_), .SI(QA_int[1]), .D(DA_int_bmux[2]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path_A[2]), .XQ(XQA|partial_corrupt_A[2]), .Q(QA_int[2]));
  datapath_latch_arm28hkcpdpsram128x8m4 uDQA3 (.CLK(CLKA), .Q_update(QA_update), .D_update(DA_sh_update), .SE(SEA_), .SI(QA_int[2]), .D(DA_int_bmux[3]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path_A[3]), .XQ(XQA|partial_corrupt_A[3]), .Q(QA_int[3]));
  datapath_latch_arm28hkcpdpsram128x8m4 uDQA4 (.CLK(CLKA), .Q_update(QA_update), .D_update(DA_sh_update), .SE(SEA_), .SI(QA_int[5]), .D(DA_int_bmux[4]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path_A[4]), .XQ(XQA|partial_corrupt_A[4]), .Q(QA_int[4]));
  datapath_latch_arm28hkcpdpsram128x8m4 uDQA5 (.CLK(CLKA), .Q_update(QA_update), .D_update(DA_sh_update), .SE(SEA_), .SI(QA_int[6]), .D(DA_int_bmux[5]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path_A[5]), .XQ(XQA|partial_corrupt_A[5]), .Q(QA_int[5]));
  datapath_latch_arm28hkcpdpsram128x8m4 uDQA6 (.CLK(CLKA), .Q_update(QA_update), .D_update(DA_sh_update), .SE(SEA_), .SI(QA_int[7]), .D(DA_int_bmux[6]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path_A[6]), .XQ(XQA|partial_corrupt_A[6]), .Q(QA_int[6]));
  datapath_latch_arm28hkcpdpsram128x8m4 uDQA7 (.CLK(CLKA), .Q_update(QA_update), .D_update(DA_sh_update), .SE(SEA_), .SI(SIA_int[1]), .D(DA_int_bmux[7]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path_A[7]), .XQ(XQA|partial_corrupt_A[7]), .Q(QA_int[7]));
...
`endif
  ...
  datapath_latch_arm28hkcpdpsram128x8m4 uDQB0 (.CLK(CLKB), .Q_update(QB_update), .D_update(DB_sh_update), .SE(SEB_), .SI(SIB_int[0]), .D(DB_int_bmux[0]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path_B[0]), .XQ(XQB|partial_corrupt_A[0]), .Q(QB_int[0]));
  datapath_latch_arm28hkcpdpsram128x8m4 uDQB1 (.CLK(CLKB), .Q_update(QB_update), .D_update(DB_sh_update), .SE(SEB_), .SI(QB_int[0]), .D(DB_int_bmux[1]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path_B[1]), .XQ(XQB|partial_corrupt_A[1]), .Q(QB_int[1]));
  datapath_latch_arm28hkcpdpsram128x8m4 uDQB2 (.CLK(CLKB), .Q_update(QB_update), .D_update(DB_sh_update), .SE(SEB_), .SI(QB_int[1]), .D(DB_int_bmux[2]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path_B[2]), .XQ(XQB|partial_corrupt_A[2]), .Q(QB_int[2]));
  datapath_latch_arm28hkcpdpsram128x8m4 uDQB3 (.CLK(CLKB), .Q_update(QB_update), .D_update(DB_sh_update), .SE(SEB_), .SI(QB_int[2]), .D(DB_int_bmux[3]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path_B[3]), .XQ(XQB|partial_corrupt_A[3]), .Q(QB_int[3]));
  datapath_latch_arm28hkcpdpsram128x8m4 uDQB4 (.CLK(CLKB), .Q_update(QB_update), .D_update(DB_sh_update), .SE(SEB_), .SI(QB_int[5]), .D(DB_int_bmux[4]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path_B[4]), .XQ(XQB|partial_corrupt_A[4]), .Q(QB_int[4]));
  datapath_latch_arm28hkcpdpsram128x8m4 uDQB5 (.CLK(CLKB), .Q_update(QB_update), .D_update(DB_sh_update), .SE(SEB_), .SI(QB_int[6]), .D(DB_int_bmux[5]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path_B[5]), .XQ(XQB|partial_corrupt_A[5]), .Q(QB_int[5]));
  datapath_latch_arm28hkcpdpsram128x8m4 uDQB6 (.CLK(CLKB), .Q_update(QB_update), .D_update(DB_sh_update), .SE(SEB_), .SI(QB_int[7]), .D(DB_int_bmux[6]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path_B[6]), .XQ(XQB|partial_corrupt_A[6]), .Q(QB_int[6]));
  datapath_latch_arm28hkcpdpsram128x8m4 uDQB7 (.CLK(CLKB), .Q_update(QB_update), .D_update(DB_sh_update), .SE(SEB_), .SI(SIB_int[1]), .D(DB_int_bmux[7]), .DFTRAMBYP(DFTRAMBYP_), .mem_path(mem_path_B[7]), .XQ(XQB|partial_corrupt_A[7]), .Q(QB_int[7]));
...
`endif
  ...
  reg NOT_WENA0, NOT_AA6, NOT_AA5, NOT_AA4, NOT_AA3, NOT_AA2, NOT_AA1, NOT_AA0, NOT_DA7;
  reg NOT_DA6, NOT_DA5, NOT_DA4, NOT_DA3, NOT_DA2, NOT_DA1, NOT_DA0, NOT_CENB, NOT_WENB7;
  reg NOT_WENB6, NOT_WENB5, NOT_WENB4, NOT_WENB3, NOT_WENB2, NOT_WENB1, NOT_WENB0;
  reg NOT_AB6, NOT_AB5, NOT_AB4, NOT_AB3, NOT_AB2, NOT_AB1, NOT_AB0, NOT_DB7, NOT_DB6;
  reg NOT_DB5, NOT_DB4, NOT_DB3, NOT_DB2, NOT_DB1, NOT_DB0, NOT_EMAA2, NOT_EMAA1, NOT_EMAA0;
  reg NOT_EMAWA1, NOT_EMAWA0, NOT_EMASA, NOT_EMAB2, NOT_EMAB1, NOT_EMAB0, NOT_EMAWB1;
  reg NOT_EMAWB0, NOT_EMASB, NOT_TENA, NOT_TCENA, NOT_TWENA7, NOT_TWENA6, NOT_TWENA5;
  reg NOT_TWENA4, NOT_TWENA3, NOT_TWENA2, NOT_TWENA1, NOT_TWENA0, NOT_TAA6, NOT_TAA5;
  reg NOT_TAA4, NOT_TAA3, NOT_TAA2, NOT_TAA1, NOT_TAA0, NOT_TDA7, NOT_TDA6, NOT_TDA5;
  reg NOT_TDA4, NOT_TDA3, NOT_TDA2, NOT_TDA1, NOT_TDA0, NOT_TENB, NOT_TCENB, NOT_TWENB7;
 ...
 wire  CLKB_;
  ...
  buf B16(CENYB, CENYB_);
  buf B17(WENYB[0], WENYB_[0]);
  buf B18(WENYB[1], WENYB_[1]);
  buf B19(WENYB[2], WENYB_[2]);
  buf B20(WENYB[3], WENYB_[3]);
  buf B21(WENYB[4], WENYB_[4]);
  buf B22(WENYB[5], WENYB_[5]);
  buf B23(WENYB[6], WENYB_[6]);
  buf B24(WENYB[7], WENYB_[7]);
  buf B25(AYB[0], AYB_[0]);
  buf B26(AYB[1], AYB_[1]);
  buf B27(AYB[2], AYB_[2]);
  buf B28(AYB[3], AYB_[3]);
  buf B29(AYB[4], AYB_[4]);
  buf B30(AYB[5], AYB_[5]);
  buf B31(AYB[6], AYB_[6]);
  buf B32(GWENYA, GWENYA_);
  buf B33(GWENYB, GWENYB_);
  buf B34(QA[0], QA_[0]);
  buf B35(QA[1], QA_[1]);
  buf B36(QA[2], QA_[2]);
  buf B37(QA[3], QA_[3]);
  ...
  buf B48(QB[6], QB_[6]);
  buf B49(QB[7], QB_[7]);
  buf B50(SOA[0], SOA_[0]);
  buf B51(SOA[1], SOA_[1]);
  buf B52(SOB[0], SOB_[0]);
  buf B53(SOB[1], SOB_[1]);
  buf B54(CLKA_, CLKA);
  buf B55(CENA_, CENA);
  buf B56(WENA_[0], WENA[0]);
  buf B57(WENA_[1], WENA[1]);
  buf B58(WENA_[2], WENA[2]);
  buf B59(WENA_[3], WENA[3]);
  buf B60(WENA_[4], WENA[4]);
  buf B61(WENA_[5], WENA[5]);
  buf B62(WENA_[6], WENA[6]);
  buf B63(WENA_[7], WENA[7]);
  buf B64(AA_[0], AA[0]);
  buf B65(AA_[1], AA[1]);
  buf B66(AA_[2], AA[2]);
  buf B67(AA_[3], AA[3]);
  ...
  buf B79(CLKB_, CLKB);
  buf B80(CENB_, CENB);
  buf B81(WENB_[0], WENB[0]);
  buf B82(WENB_[1], WENB[1]);
  buf B83(WENB_[2], WENB[2]);
  buf B84(WENB_[3], WENB[3]);
  buf B85(WENB_[4], WENB[4]);
  buf B86(WENB_[5], WENB[5]);
  buf B87(WENB_[6], WENB[6]);
  buf B88(WENB_[7], WENB[7]);
  buf B89(AB_[0], AB[0]);
  buf B90(AB_[1], AB[1]);
  buf B91(AB_[2], AB[2]);
  buf B92(AB_[3], AB[3]);
  ...
  buf B107(EMAWA_[0], EMAWA[0]);
  buf B108(EMAWA_[1], EMAWA[1]);
  buf B109(EMASA_, EMASA);
  buf B110(EMAB_[0], EMAB[0]);
  buf B111(EMAB_[1], EMAB[1]);
  buf B112(EMAB_[2], EMAB[2]);
  buf B113(EMAWB_[0], EMAWB[0]);
  buf B114(EMAWB_[1], EMAWB[1]);
  buf B115(EMASB_, EMASB);
  buf B116(TENA_, TENA);
  buf B117(TCENA_, TCENA);
  buf B118(TWENA_[0], TWENA[0]);
  buf B119(TWENA_[1], TWENA[1]);
  buf B120(TWENA_[2], TWENA[2]);
  buf B121(TWENA_[3], TWENA[3]);
  buf B122(TWENA_[4], TWENA[4]);
  buf B123(TWENA_[5], TWENA[5]);
  buf B124(TWENA_[6], TWENA[6]);
  buf B125(TWENA_[7], TWENA[7]);
  ...
  buf B133(TDA_[0], TDA[0]);
  buf B134(TDA_[1], TDA[1]);
  buf B135(TDA_[2], TDA[2]);
  buf B136(TDA_[3], TDA[3]);
  buf B137(TDA_[4], TDA[4]);
  buf B138(TDA_[5], TDA[5]);
  buf B139(TDA_[6], TDA[6]);
  buf B140(TDA_[7], TDA[7]);
  buf B141(TENB_, TENB);
  buf B142(TCENB_, TCENB);
  buf B143(TWENB_[0], TWENB[0]);
  buf B144(TWENB_[1], TWENB[1]);
  buf B145(TWENB_[2], TWENB[2]);
  buf B146(TWENB_[3], TWENB[3]);
  buf B147(TWENB_[4], TWENB[4]);
  buf B148(TWENB_[5], TWENB[5]);
  buf B149(TWENB_[6], TWENB[6]);
  buf B150(TWENB_[7], TWENB[7]);
  buf B151(TAB_[0], TAB[0]);
  buf B152(TAB_[1], TAB[1]);
  buf B153(TAB_[2], TAB[2]);
  buf B154(TAB_[3], TAB[3]);
  buf B155(TAB_[4], TAB[4]);
  buf B156(TAB_[5], TAB[5]);
  buf B157(TAB_[6], TAB[6]);
  buf B158(TDB_[0], TDB[0]);
  buf B159(TDB_[1], TDB[1]);
  buf B160(TDB_[2], TDB[2]);
  buf B161(TDB_[3], TDB[3]);
  buf B162(TDB_[4], TDB[4]);
  buf B163(TDB_[5], TDB[5]);
  buf B164(TDB_[6], TDB[6]);
  buf B165(TDB_[7], TDB[7]);
  buf B166(GWENA_, GWENA);
  buf B167(GWENB_, GWENB);
  buf B168(TGWENA_, TGWENA);
  buf B169(TGWENB_, TGWENB);
  buf B170(RET1N_, RET1N);
  buf B171(SIA_[0], SIA[0]);
  buf B172(SIA_[1], SIA[1]);
  buf B173(SEA_, SEA);
  buf B174(DFTRAMBYP_, DFTRAMBYP);
  buf B175(SIB_[0], SIB[0]);
  buf B176(SIB_[1], SIB[1]);
  buf B177(SEB_, SEB);
  buf B178(COLLDISN_, COLLDISN);
...
`endif
`timescale 1ns/1ps
module arm28hkcpdpsram128x8m4_error_injection (Q_out, Q_in, CLK, A, CEN, DFTRAMBYP, SE, WEN, GWEN);
   output [7:0] Q_out;
   input [7:0] Q_in;
   input CLK;
   input [6:0] A;
...
begin
   ...
   `ifdef ARM_NONREPAIRABLE_FAULT
      `pre_pend_path.SMARCHCHKBVCD_LVISION_MBISTPG_ASSEMBLY_UNDER_TEST_INST.MEM0_MEM_INST.u1.add_fault(7'd2,3'd6,2'd1,2'd0);
   `endif
end
   task add_fault;
