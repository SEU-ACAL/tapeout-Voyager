...
/*
    ...
    Filename   : smic281prf128x31m4.v
    IP code    : S28HKCPHD1PRF
    Version    : V0P2A
    CreateDate : Jul 20, 2025 2:37:52 PM

    Verilog Model for High Speed One-Port SRAM
    SMIC 28 SFE Process

    Configuration: -instname smic281prf128x31m4 
                   -words 128 -bits 31 -mux 4 -bank 1
...
`endif
  ...
  parameter D_WIDTH      = 31;  // data bits
  parameter MUX          = 4;  // mux
  parameter MEM_WIDTH    = 124; 
...
`endif
  ...
  begin
      ...
      pos = 124'b0001000100010001000100010001000100010001000100010001000100010001000100010001000100010001000100010001000100010001000100010001 << col_address;
...
`endif
  assign nf_inputs_z = (CLK_buf === 1'bz) || (CEN_buf === 1'bz) || (WEN_buf === 1'bz) || (A_buf[0] === 1'bz) || (A_buf[1] === 1'bz) || 
                ...
                (D_buf[30] === 1'bz) || (BWEN_buf[0] === 1'bz) || (BWEN_buf[1] === 1'bz) || (BWEN_buf[2] === 1'bz) || (BWEN_buf[3] === 1'bz) || 
                ...
                (BWEN_buf[29] === 1'bz) || (BWEN_buf[30] === 1'bz) || 1'b0;
...
`else
  ...
  always @(TM_noti) begin
    ...
    assign BWEN_tmp[30] = ^BWEN[30];`endif
endmodule
`endcelldefine
