...
/*
    ...
    Filename   : smic281prf512x64m4.v
    IP code    : S28HKCPHD1PRF
    Version    : V0P2A
    CreateDate : Jul 20, 2025 2:37:32 PM

    Verilog Model for High Speed One-Port SRAM
    SMIC 28 SFE Process

    Configuration: -instname smic281prf512x64m4 
                   -words 512 -bits 64 -mux 4 -bank 1
...
`endif
  ...
  // PARAMETERS
  //////////////////////////////////////////////
  parameter WORDS        = 512;  // words
  parameter A_WIDTH      = 9;  // address bits
...
`endif
  assign nf_inputs_z = (CLK_buf === 1'bz) || (CEN_buf === 1'bz) || (WEN_buf === 1'bz) || (A_buf[0] === 1'bz) || (A_buf[1] === 1'bz) || 
                ...
                (A_buf[7] === 1'bz) || (A_buf[8] === 1'bz) || (D_buf[0] === 1'bz) || (D_buf[1] === 1'bz) || (D_buf[2] === 1'bz) || 
                (D_buf[3] === 1'bz) || (D_buf[4] === 1'bz) || (D_buf[5] === 1'bz) || (D_buf[6] === 1'bz) || (D_buf[7] === 1'bz) || 
                (D_buf[8] === 1'bz) || (D_buf[9] === 1'bz) || (D_buf[10] === 1'bz) || (D_buf[11] === 1'bz) || (D_buf[12] === 1'bz) || 
                (D_buf[13] === 1'bz) || (D_buf[14] === 1'bz) || (D_buf[15] === 1'bz) || (D_buf[16] === 1'bz) || (D_buf[17] === 1'bz) || 
                (D_buf[18] === 1'bz) || (D_buf[19] === 1'bz) || (D_buf[20] === 1'bz) || (D_buf[21] === 1'bz) || (D_buf[22] === 1'bz) || 
                (D_buf[23] === 1'bz) || (D_buf[24] === 1'bz) || (D_buf[25] === 1'bz) || (D_buf[26] === 1'bz) || (D_buf[27] === 1'bz) || 
                (D_buf[28] === 1'bz) || (D_buf[29] === 1'bz) || (D_buf[30] === 1'bz) || (D_buf[31] === 1'bz) || (D_buf[32] === 1'bz) || 
                (D_buf[33] === 1'bz) || (D_buf[34] === 1'bz) || (D_buf[35] === 1'bz) || (D_buf[36] === 1'bz) || (D_buf[37] === 1'bz) || 
                (D_buf[38] === 1'bz) || (D_buf[39] === 1'bz) || (D_buf[40] === 1'bz) || (D_buf[41] === 1'bz) || (D_buf[42] === 1'bz) || 
                (D_buf[43] === 1'bz) || (D_buf[44] === 1'bz) || (D_buf[45] === 1'bz) || (D_buf[46] === 1'bz) || (D_buf[47] === 1'bz) || 
                (D_buf[48] === 1'bz) || (D_buf[49] === 1'bz) || (D_buf[50] === 1'bz) || (D_buf[51] === 1'bz) || (D_buf[52] === 1'bz) || 
                (D_buf[53] === 1'bz) || (D_buf[54] === 1'bz) || (D_buf[55] === 1'bz) || (D_buf[56] === 1'bz) || (D_buf[57] === 1'bz) || 
                (D_buf[58] === 1'bz) || (D_buf[59] === 1'bz) || (D_buf[60] === 1'bz) || (D_buf[61] === 1'bz) || (D_buf[62] === 1'bz) || 
                (D_buf[63] === 1'bz) || (BWEN_buf[0] === 1'bz) || (BWEN_buf[1] === 1'bz) || (BWEN_buf[2] === 1'bz) || (BWEN_buf[3] === 1'bz) || 
                (BWEN_buf[4] === 1'bz) || (BWEN_buf[5] === 1'bz) || (BWEN_buf[6] === 1'bz) || (BWEN_buf[7] === 1'bz) || (BWEN_buf[8] === 1'bz) || 
                (BWEN_buf[9] === 1'bz) || (BWEN_buf[10] === 1'bz) || (BWEN_buf[11] === 1'bz) || (BWEN_buf[12] === 1'bz) || (BWEN_buf[13] === 1'bz) || 
                (BWEN_buf[14] === 1'bz) || (BWEN_buf[15] === 1'bz) || (BWEN_buf[16] === 1'bz) || (BWEN_buf[17] === 1'bz) || (BWEN_buf[18] === 1'bz) || 
                (BWEN_buf[19] === 1'bz) || (BWEN_buf[20] === 1'bz) || (BWEN_buf[21] === 1'bz) || (BWEN_buf[22] === 1'bz) || (BWEN_buf[23] === 1'bz) || 
                (BWEN_buf[24] === 1'bz) || (BWEN_buf[25] === 1'bz) || (BWEN_buf[26] === 1'bz) || (BWEN_buf[27] === 1'bz) || (BWEN_buf[28] === 1'bz) || 
                (BWEN_buf[29] === 1'bz) || (BWEN_buf[30] === 1'bz) || (BWEN_buf[31] === 1'bz) || (BWEN_buf[32] === 1'bz) || (BWEN_buf[33] === 1'bz) || 
                (BWEN_buf[34] === 1'bz) || (BWEN_buf[35] === 1'bz) || (BWEN_buf[36] === 1'bz) || (BWEN_buf[37] === 1'bz) || (BWEN_buf[38] === 1'bz) || 
                (BWEN_buf[39] === 1'bz) || (BWEN_buf[40] === 1'bz) || (BWEN_buf[41] === 1'bz) || (BWEN_buf[42] === 1'bz) || (BWEN_buf[43] === 1'bz) || 
                (BWEN_buf[44] === 1'bz) || (BWEN_buf[45] === 1'bz) || (BWEN_buf[46] === 1'bz) || (BWEN_buf[47] === 1'bz) || (BWEN_buf[48] === 1'bz) || 
                (BWEN_buf[49] === 1'bz) || (BWEN_buf[50] === 1'bz) || (BWEN_buf[51] === 1'bz) || (BWEN_buf[52] === 1'bz) || (BWEN_buf[53] === 1'bz) || 
                (BWEN_buf[54] === 1'bz) || (BWEN_buf[55] === 1'bz) || (BWEN_buf[56] === 1'bz) || (BWEN_buf[57] === 1'bz) || (BWEN_buf[58] === 1'bz) || 
                (BWEN_buf[59] === 1'bz) || (BWEN_buf[60] === 1'bz) || (BWEN_buf[61] === 1'bz) || (BWEN_buf[62] === 1'bz) || (BWEN_buf[63] === 1'bz) || 1'b0;
