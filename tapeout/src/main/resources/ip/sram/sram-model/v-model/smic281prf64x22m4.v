...
/*
    ...
    Filename   : smic281prf64x22m4.v
    IP code    : S28HKCPHD1PRF
    Version    : V0P2A
    CreateDate : Jul 11, 2025 11:55:01 AM

    Verilog Model for High Speed One-Port SRAM
    SMIC 28 SFE Process

    Configuration: -instname smic281prf64x22m4 
                   -words 64 -bits 22 -mux 4 -bank 1
...
`endif
  ...
  parameter D_WIDTH      = 22;  // data bits
  parameter MUX          = 4;  // mux
  parameter MEM_WIDTH    = 88; 
...
`endif
  ...
  begin
      mem_rd_rslt = {mem_latch[84], mem_latch[80], mem_latch[76], 
  ...
  begin
      ...
      data_new = {3'b000, data_real[21], 3'b000, data_real[20], 3'b000, data_real[19], 3'b000, data_real[18], 
      ...
      pos = 88'b0001000100010001000100010001000100010001000100010001000100010001000100010001000100010001 << col_address;
...
`endif
  assign nf_inputs_z = (CLK_buf === 1'bz) || (CEN_buf === 1'bz) || (WEN_buf === 1'bz) || (A_buf[0] === 1'bz) || (A_buf[1] === 1'bz) || 
                ...
                (D_buf[21] === 1'bz) || (BWEN_buf[0] === 1'bz) || (BWEN_buf[1] === 1'bz) || (BWEN_buf[2] === 1'bz) || (BWEN_buf[3] === 1'bz) || 
                ...
                (BWEN_buf[19] === 1'bz) || (BWEN_buf[20] === 1'bz) || (BWEN_buf[21] === 1'bz) || 1'b0;
...
`else
  ...
  always @(TM_noti) begin
    ...
    assign BWEN_tmp[21] = ^BWEN[21];`endif
endmodule
`endcelldefine
