...
/*
    ...
    Filename   : smic281prf512x45m4.v
    IP code    : S28HKCPHD1PRF
    Version    : V0P2A
    CreateDate : Jul 11, 2025 11:54:31 AM

    Verilog Model for High Speed One-Port SRAM
    SMIC 28 SFE Process

    Configuration: -instname smic281prf512x45m4 
                   -words 512 -bits 45 -mux 4 -bank 1
...
`endif
  ...
  parameter D_WIDTH      = 45;  // data bits
  parameter MUX          = 4;  // mux
  parameter MEM_WIDTH    = 180; 
...
`endif
  ...
  begin
      mem_rd_rslt = {mem_latch[176], mem_latch[172], 
  ...
  begin
      ...
      data_new = {3'b000, data_real[44], 3'b000, data_real[43], 3'b000, data_real[42], 
      ...
      pos = 180'b000100010001000100010001000100010001000100010001000100010001000100010001000100010001000100010001000100010001000100010001000100010001000100010001000100010001000100010001000100010001 << col_address;
...
`endif
  assign nf_inputs_z = (CLK_buf === 1'bz) || (CEN_buf === 1'bz) || (WEN_buf === 1'bz) || (A_buf[0] === 1'bz) || (A_buf[1] === 1'bz) || 
                ...
                (D_buf[43] === 1'bz) || (D_buf[44] === 1'bz) || (BWEN_buf[0] === 1'bz) || (BWEN_buf[1] === 1'bz) || (BWEN_buf[2] === 1'bz) || 
                ...
                (BWEN_buf[43] === 1'bz) || (BWEN_buf[44] === 1'bz) || 1'b0;
...
`else
  ...
  always @(TM_noti) begin
    ...
    assign BWEN_tmp[44] = ^BWEN[44];`endif
endmodule
`endcelldefine
