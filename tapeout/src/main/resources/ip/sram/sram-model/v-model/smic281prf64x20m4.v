...
/*
    ...
    Filename   : smic281prf64x20m4.v
    IP code    : S28HKCPHD1PRF
    Version    : V0P2A
    CreateDate : Jul 11, 2025 11:54:46 AM

    Verilog Model for High Speed One-Port SRAM
    SMIC 28 SFE Process

    Configuration: -instname smic281prf64x20m4 
                   -words 64 -bits 20 -mux 4 -bank 1
...
`endif
  ...
  parameter D_WIDTH      = 20;  // data bits
  parameter MUX          = 4;  // mux
  parameter MEM_WIDTH    = 80; 
...
`endif
  ...
  begin
      ...
      data_new = {3'b000, data_real[19], 3'b000, data_real[18], 
      ...
      pos = 80'b00010001000100010001000100010001000100010001000100010001000100010001000100010001 << col_address;
...
`endif
  assign nf_inputs_z = (CLK_buf === 1'bz) || (CEN_buf === 1'bz) || (WEN_buf === 1'bz) || (A_buf[0] === 1'bz) || (A_buf[1] === 1'bz) || 
                ...
                (D_buf[16] === 1'bz) || (D_buf[17] === 1'bz) || (D_buf[18] === 1'bz) || (D_buf[19] === 1'bz) || (BWEN_buf[0] === 1'bz) || 
                ...
                (BWEN_buf[16] === 1'bz) || (BWEN_buf[17] === 1'bz) || (BWEN_buf[18] === 1'bz) || (BWEN_buf[19] === 1'bz) || 1'b0;
...
`else
  ...
  always @(TM_noti) begin
    ...
    assign BWEN_tmp[19] = ^BWEN[19];`endif
endmodule
`endcelldefine
