...
/*
    ...
    Filename   : smic28sp4096x64m8.v
    IP code    : S28HKCPHDSP
    Version    : V0P2
    CreateDate : Jul 11, 2025 12:00:08 PM

    Verilog Model for High Speed Single-Port SRAM
    SMIC 28 SFE Process

    Configuration: -instname smic28sp4096x64m8 
                   -words 4096 -bits 64 -mux 8 -bank 4
...
`endif
  ...
  // PARAMETERS
  //////////////////////////////////////////////
  parameter WORDS        = 4096;  // words
  parameter A_WIDTH      = 12;  // address bits
...
`endif
  ...
  begin
      mem_rd_rslt = {mem_latch[504], mem_latch[496], mem_latch[488], 
          mem_latch[480], mem_latch[472], mem_latch[464], mem_latch[456], mem_latch[448], mem_latch[440], 
          mem_latch[432], mem_latch[424], mem_latch[416], mem_latch[408], mem_latch[400], mem_latch[392], 
          mem_latch[384], mem_latch[376], mem_latch[368], mem_latch[360], mem_latch[352], mem_latch[344], 
          mem_latch[336], mem_latch[328], mem_latch[320], mem_latch[312], mem_latch[304], mem_latch[296], 
          mem_latch[288], mem_latch[280], mem_latch[272], mem_latch[264], mem_latch[256], mem_latch[248], 
          mem_latch[240], mem_latch[232], mem_latch[224], mem_latch[216], mem_latch[208], mem_latch[200], 
          mem_latch[192], mem_latch[184], mem_latch[176], mem_latch[168], mem_latch[160], mem_latch[152], 
          mem_latch[144], mem_latch[136], mem_latch[128], mem_latch[120], mem_latch[112], mem_latch[104], 
          mem_latch[96], mem_latch[88], mem_latch[80], mem_latch[72], mem_latch[64], mem_latch[56], 
          mem_latch[48], mem_latch[40], mem_latch[32], mem_latch[24], mem_latch[16], mem_latch[8], mem_latch[0]};      
  end    
  endfunction 
  ...
  begin
      ...
      data_new = {7'b0000000, data_real[63], 7'b0000000, data_real[62], 7'b0000000, data_real[61], 7'b0000000, data_real[60], 
          7'b0000000, data_real[59], 7'b0000000, data_real[58], 7'b0000000, data_real[57], 7'b0000000, data_real[56], 7'b0000000, data_real[55], 7'b0000000, data_real[54], 
          7'b0000000, data_real[53], 7'b0000000, data_real[52], 7'b0000000, data_real[51], 7'b0000000, data_real[50], 7'b0000000, data_real[49], 7'b0000000, data_real[48], 
          7'b0000000, data_real[47], 7'b0000000, data_real[46], 7'b0000000, data_real[45], 7'b0000000, data_real[44], 7'b0000000, data_real[43], 7'b0000000, data_real[42], 
          7'b0000000, data_real[41], 7'b0000000, data_real[40], 7'b0000000, data_real[39], 7'b0000000, data_real[38], 7'b0000000, data_real[37], 7'b0000000, data_real[36], 
          7'b0000000, data_real[35], 7'b0000000, data_real[34], 7'b0000000, data_real[33], 7'b0000000, data_real[32], 7'b0000000, data_real[31], 7'b0000000, data_real[30], 
          7'b0000000, data_real[29], 7'b0000000, data_real[28], 7'b0000000, data_real[27], 7'b0000000, data_real[26], 7'b0000000, data_real[25], 7'b0000000, data_real[24], 
          7'b0000000, data_real[23], 7'b0000000, data_real[22], 7'b0000000, data_real[21], 7'b0000000, data_real[20], 7'b0000000, data_real[19], 7'b0000000, data_real[18], 
          7'b0000000, data_real[17], 7'b0000000, data_real[16], 7'b0000000, data_real[15], 7'b0000000, data_real[14], 7'b0000000, data_real[13], 7'b0000000, data_real[12], 
          7'b0000000, data_real[11], 7'b0000000, data_real[10], 7'b0000000, data_real[9], 7'b0000000, data_real[8], 7'b0000000, data_real[7], 7'b0000000, data_real[6], 
          7'b0000000, data_real[5], 7'b0000000, data_real[4], 7'b0000000, data_real[3], 7'b0000000, data_real[2], 7'b0000000, data_real[1], 7'b0000000, data_real[0]} << col_address;
      pos = 512' << col_address;
...
`endif
  assign nf_inputs_z = (CLK_buf === 1'bz) || (CEN_buf === 1'bz) || (WEN_buf === 1'bz) || (A_buf[0] === 1'bz) || (A_buf[1] === 1'bz) || 
                ...
                (A_buf[7] === 1'bz) || (A_buf[8] === 1'bz) || (A_buf[9] === 1'bz) || (A_buf[10] === 1'bz) || (A_buf[11] === 1'bz) || 
                (D_buf[0] === 1'bz) || (D_buf[1] === 1'bz) || (D_buf[2] === 1'bz) || (D_buf[3] === 1'bz) || (D_buf[4] === 1'bz) || 
                (D_buf[5] === 1'bz) || (D_buf[6] === 1'bz) || (D_buf[7] === 1'bz) || (D_buf[8] === 1'bz) || (D_buf[9] === 1'bz) || 
                (D_buf[10] === 1'bz) || (D_buf[11] === 1'bz) || (D_buf[12] === 1'bz) || (D_buf[13] === 1'bz) || (D_buf[14] === 1'bz) || 
                (D_buf[15] === 1'bz) || (D_buf[16] === 1'bz) || (D_buf[17] === 1'bz) || (D_buf[18] === 1'bz) || (D_buf[19] === 1'bz) || 
                (D_buf[20] === 1'bz) || (D_buf[21] === 1'bz) || (D_buf[22] === 1'bz) || (D_buf[23] === 1'bz) || (D_buf[24] === 1'bz) || 
                (D_buf[25] === 1'bz) || (D_buf[26] === 1'bz) || (D_buf[27] === 1'bz) || (D_buf[28] === 1'bz) || (D_buf[29] === 1'bz) || 
                (D_buf[30] === 1'bz) || (D_buf[31] === 1'bz) || (D_buf[32] === 1'bz) || (D_buf[33] === 1'bz) || (D_buf[34] === 1'bz) || 
                (D_buf[35] === 1'bz) || (D_buf[36] === 1'bz) || (D_buf[37] === 1'bz) || (D_buf[38] === 1'bz) || (D_buf[39] === 1'bz) || 
                (D_buf[40] === 1'bz) || (D_buf[41] === 1'bz) || (D_buf[42] === 1'bz) || (D_buf[43] === 1'bz) || (D_buf[44] === 1'bz) || 
                (D_buf[45] === 1'bz) || (D_buf[46] === 1'bz) || (D_buf[47] === 1'bz) || (D_buf[48] === 1'bz) || (D_buf[49] === 1'bz) || 
                (D_buf[50] === 1'bz) || (D_buf[51] === 1'bz) || (D_buf[52] === 1'bz) || (D_buf[53] === 1'bz) || (D_buf[54] === 1'bz) || 
                (D_buf[55] === 1'bz) || (D_buf[56] === 1'bz) || (D_buf[57] === 1'bz) || (D_buf[58] === 1'bz) || (D_buf[59] === 1'bz) || 
                (D_buf[60] === 1'bz) || (D_buf[61] === 1'bz) || (D_buf[62] === 1'bz) || (D_buf[63] === 1'bz) || (BWEN_buf[0] === 1'bz) || 
                (BWEN_buf[1] === 1'bz) || (BWEN_buf[2] === 1'bz) || (BWEN_buf[3] === 1'bz) || (BWEN_buf[4] === 1'bz) || (BWEN_buf[5] === 1'bz) || 
                (BWEN_buf[6] === 1'bz) || (BWEN_buf[7] === 1'bz) || (BWEN_buf[8] === 1'bz) || (BWEN_buf[9] === 1'bz) || (BWEN_buf[10] === 1'bz) || 
                (BWEN_buf[11] === 1'bz) || (BWEN_buf[12] === 1'bz) || (BWEN_buf[13] === 1'bz) || (BWEN_buf[14] === 1'bz) || (BWEN_buf[15] === 1'bz) || 
                (BWEN_buf[16] === 1'bz) || (BWEN_buf[17] === 1'bz) || (BWEN_buf[18] === 1'bz) || (BWEN_buf[19] === 1'bz) || (BWEN_buf[20] === 1'bz) || 
                (BWEN_buf[21] === 1'bz) || (BWEN_buf[22] === 1'bz) || (BWEN_buf[23] === 1'bz) || (BWEN_buf[24] === 1'bz) || (BWEN_buf[25] === 1'bz) || 
                (BWEN_buf[26] === 1'bz) || (BWEN_buf[27] === 1'bz) || (BWEN_buf[28] === 1'bz) || (BWEN_buf[29] === 1'bz) || (BWEN_buf[30] === 1'bz) || 
                (BWEN_buf[31] === 1'bz) || (BWEN_buf[32] === 1'bz) || (BWEN_buf[33] === 1'bz) || (BWEN_buf[34] === 1'bz) || (BWEN_buf[35] === 1'bz) || 
                (BWEN_buf[36] === 1'bz) || (BWEN_buf[37] === 1'bz) || (BWEN_buf[38] === 1'bz) || (BWEN_buf[39] === 1'bz) || (BWEN_buf[40] === 1'bz) || 
                (BWEN_buf[41] === 1'bz) || (BWEN_buf[42] === 1'bz) || (BWEN_buf[43] === 1'bz) || (BWEN_buf[44] === 1'bz) || (BWEN_buf[45] === 1'bz) || 
                (BWEN_buf[46] === 1'bz) || (BWEN_buf[47] === 1'bz) || (BWEN_buf[48] === 1'bz) || (BWEN_buf[49] === 1'bz) || (BWEN_buf[50] === 1'bz) || 
                (BWEN_buf[51] === 1'bz) || (BWEN_buf[52] === 1'bz) || (BWEN_buf[53] === 1'bz) || (BWEN_buf[54] === 1'bz) || (BWEN_buf[55] === 1'bz) || 
                (BWEN_buf[56] === 1'bz) || (BWEN_buf[57] === 1'bz) || (BWEN_buf[58] === 1'bz) || (BWEN_buf[59] === 1'bz) || (BWEN_buf[60] === 1'bz) || 
                (BWEN_buf[61] === 1'bz) || (BWEN_buf[62] === 1'bz) || (BWEN_buf[63] === 1'bz) || 1'b0;
...
`else
  ...
  always @(TM_noti) begin
    ...
    assign A_tmp[8] = ^A[8];
    assign A_tmp[9] = ^A[9];
    assign A_tmp[10] = ^A[10];
    assign A_tmp[11] = ^A[11];
    wire   [63:0] D_tmp;
    assign D_tmp[0] = ^D[0];
    assign D_tmp[1] = ^D[1];
    assign D_tmp[2] = ^D[2];
