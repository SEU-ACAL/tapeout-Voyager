...
/*
    ...
    Filename   : smic281prf1024x8m4.v
    IP code    : S28HKCPHD1PRF
    Version    : V0P2A
    CreateDate : Jul 19, 2025 4:37:08 PM

    Verilog Model for High Speed One-Port SRAM
    SMIC 28 SFE Process

    Configuration: -instname smic281prf1024x8m4 
                   -words 1024 -bits 8 -mux 4 -bank 1
...
`endif
  assign nf_inputs_z = (CLK_buf === 1'bz) || (CEN_buf === 1'bz) || (WEN_buf === 1'bz) || (A_buf[0] === 1'bz) || (A_buf[1] === 1'bz) || 
                ...
                (D_buf[7] === 1'bz) || (BWEN_buf[0] === 1'bz) || (BWEN_buf[1] === 1'bz) || (BWEN_buf[2] === 1'bz) || (BWEN_buf[3] === 1'bz) || 
                (BWEN_buf[4] === 1'bz) || (BWEN_buf[5] === 1'bz) || (BWEN_buf[6] === 1'bz) || (BWEN_buf[7] === 1'bz) || 1'b0;
