...
/*
    ...
    Filename   : smic281prf64x21m4.v
    IP code    : S28HKCPHD1PRF
    Version    : V0P2A
    CreateDate : Jul 11, 2025 11:55:45 AM

    Verilog Model for High Speed One-Port SRAM
    SMIC 28 SFE Process

    Configuration: -instname smic281prf64x21m4 
                   -words 64 -bits 21 -mux 4 -bank 1
...
`endif
  ...
  parameter D_WIDTH      = 21;  // data bits
  parameter MUX          = 4;  // mux
  parameter MEM_WIDTH    = 84; 
...
`endif
  ...
  begin
      mem_rd_rslt = {mem_latch[80], mem_latch[76], 
  ...
  begin
      ...
      data_new = {3'b000, data_real[20], 3'b000, data_real[19], 3'b000, data_real[18], 
      ...
      pos = 84'b000100010001000100010001000100010001000100010001000100010001000100010001000100010001 << col_address;
...
`else
  ...
  always @(TM_noti) begin
    ...
    assign BWEN_tmp[20] = ^BWEN[20];`endif
endmodule
`endcelldefine
