...
/*
    ...
    Filename   : smic281prf256x32m4.v
    IP code    : S28HKCPHD1PRF
    Version    : V0P2A
    CreateDate : Jul 11, 2025 11:56:02 AM

    Verilog Model for High Speed One-Port SRAM
    SMIC 28 SFE Process

    Configuration: -instname smic281prf256x32m4 
                   -words 256 -bits 32 -mux 4 -bank 1
...
`endif
  ...
  parameter D_WIDTH      = 32;  // data bits
  parameter MUX          = 4;  // mux
...
`endif
  ...
  begin
      ...
      data_new = {3'b000, data_real[31], 3'b000, data_real[30], 
      ...
      pos = 128'b00010001000100010001000100010001000100010001000100010001000100010001000100010001000100010001000100010001000100010001000100010001 << col_address;
...
`endif
  assign nf_inputs_z = (CLK_buf === 1'bz) || (CEN_buf === 1'bz) || (WEN_buf === 1'bz) || (A_buf[0] === 1'bz) || (A_buf[1] === 1'bz) || 
                ...
                (D_buf[29] === 1'bz) || (D_buf[30] === 1'bz) || (D_buf[31] === 1'bz) || (BWEN_buf[0] === 1'bz) || (BWEN_buf[1] === 1'bz) || 
                ...
                (BWEN_buf[27] === 1'bz) || (BWEN_buf[28] === 1'bz) || (BWEN_buf[29] === 1'bz) || (BWEN_buf[30] === 1'bz) || (BWEN_buf[31] === 1'bz) || 1'b0;
...
`else
  ...
  always @(TM_noti) begin
    ...
    assign BWEN_tmp[31] = ^BWEN[31];`endif
endmodule
`endcelldefine
