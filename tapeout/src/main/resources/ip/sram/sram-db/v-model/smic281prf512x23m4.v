...
/*
    ...
    Filename   : smic281prf512x23m4.v
    IP code    : S28HKCPHD1PRF
    Version    : V0P2A
    CreateDate : Jul 11, 2025 11:53:17 AM

    Verilog Model for High Speed One-Port SRAM
    SMIC 28 SFE Process

    Configuration: -instname smic281prf512x23m4 
                   -words 512 -bits 23 -mux 4 -bank 1
...
`endif
  assign nf_inputs_z = (CLK_buf === 1'bz) || (CEN_buf === 1'bz) || (WEN_buf === 1'bz) || (A_buf[0] === 1'bz) || (A_buf[1] === 1'bz) || 
                ...
                (BWEN_buf[20] === 1'bz) || (BWEN_buf[21] === 1'bz) || (BWEN_buf[22] === 1'bz) || 1'b0;
