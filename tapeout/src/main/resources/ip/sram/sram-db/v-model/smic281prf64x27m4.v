...
/*
    ...
    Filename   : smic281prf64x27m4.v
    IP code    : S28HKCPHD1PRF
    Version    : V0P2A
    CreateDate : Jul 20, 2025 2:38:37 PM

    Verilog Model for High Speed One-Port SRAM
    SMIC 28 SFE Process

    Configuration: -instname smic281prf64x27m4 
                   -words 64 -bits 27 -mux 4 -bank 1
...
`endif
  ...
  parameter D_WIDTH      = 27;  // data bits
  parameter MUX          = 4;  // mux
  parameter MEM_WIDTH    = 108; 
...
`endif
  ...
  begin
      mem_rd_rslt = {mem_latch[104], mem_latch[100], 
  ...
  begin
      ...
      data_new = {3'b000, data_real[26], 3'b000, data_real[25], 3'b000, data_real[24], 
      ...
      pos = 108'b000100010001000100010001000100010001000100010001000100010001000100010001000100010001000100010001000100010001 << col_address;
...
`endif
  assign nf_inputs_z = (CLK_buf === 1'bz) || (CEN_buf === 1'bz) || (WEN_buf === 1'bz) || (A_buf[0] === 1'bz) || (A_buf[1] === 1'bz) || 
                ...
                (D_buf[26] === 1'bz) || (BWEN_buf[0] === 1'bz) || (BWEN_buf[1] === 1'bz) || (BWEN_buf[2] === 1'bz) || (BWEN_buf[3] === 1'bz) || 
                ...
                (BWEN_buf[24] === 1'bz) || (BWEN_buf[25] === 1'bz) || (BWEN_buf[26] === 1'bz) || 1'b0;
...
`else
  ...
  always @(TM_noti) begin
    ...
    assign BWEN_tmp[26] = ^BWEN[26];`endif
endmodule
`endcelldefine
