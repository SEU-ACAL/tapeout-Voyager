...
/*
    ...
    Filename   : smic28sp4096x8m8.v
    IP code    : S28HKCPHDSP
    Version    : V0P2
    CreateDate : Jul 11, 2025 12:00:35 PM

    Verilog Model for High Speed Single-Port SRAM
    SMIC 28 SFE Process

    Configuration: -instname smic28sp4096x8m8 
                   -words 4096 -bits 8 -mux 8 -bank 4
...
`endif
  assign nf_inputs_z = (CLK_buf === 1'bz) || (CEN_buf === 1'bz) || (WEN_buf === 1'bz) || (A_buf[0] === 1'bz) || (A_buf[1] === 1'bz) || 
                ...
                (D_buf[5] === 1'bz) || (D_buf[6] === 1'bz) || (D_buf[7] === 1'bz) || (BWEN_buf[0] === 1'bz) || (BWEN_buf[1] === 1'bz) || 
                (BWEN_buf[2] === 1'bz) || (BWEN_buf[3] === 1'bz) || (BWEN_buf[4] === 1'bz) || (BWEN_buf[5] === 1'bz) || (BWEN_buf[6] === 1'bz) || 
                (BWEN_buf[7] === 1'bz) || 1'b0;
