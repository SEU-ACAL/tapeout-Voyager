...
class CustomTLToAXI4(val combinational: Boolean = true, val adapterName: Option[String] = None, val stripBits: Int = 0, val wcorrupt: Boolean = true)(implicit p: Parameters) extends LazyModule
{
...
object CustomTLToAXI4
{
  ...
  {
    val tl2axi4 = LazyModule(new CustomTLToAXI4(combinational, adapterName, stripBits, wcorrupt))
    tl2axi4.node
  }
