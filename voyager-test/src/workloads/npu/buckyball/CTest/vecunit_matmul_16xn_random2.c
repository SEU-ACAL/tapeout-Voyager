...
int test_random2() {
    init_random_matrix(input_matrix_a, DIM, 256, 111);
    init_random_matrix(input_matrix_b, 256, DIM, 222);
    return run_test("Random matrices 2", input_matrix_a, input_matrix_b, 256);
}
