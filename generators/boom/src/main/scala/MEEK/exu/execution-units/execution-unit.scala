...
import boom.meek.ifu.{GetPCFromFtqIO}
import boom.meek.util.{ImmGen, IsKilledByBranch, BranchKillableQueue, BoomCoreStringPrefix}
  ...
  )(implicit p: Parameters) extends BoomModule
{
  ...
  val io = IO(new Bundle {
    ...
    val lsu_io = if (hasMem) Flipped(new boom.meek.lsu.LSUExeIO) else null
