...
package boom.meek.common.constants
...
//val uopSRET = 40.U(UOPC_SZ.W)
  ...
  def NullMicroOp()(implicit p: Parameters): boom.meek.common.MicroOp = {
    val uop = Wire(new boom.meek.common.MicroOp)
    ...
    val cs = Wire(new boom.meek.common.CtrlSignals())
...
trait RISCVConstants
{
  ...
  def GetCfiType(inst: UInt)(implicit p: Parameters): UInt = {
    val bdecode = Module(new boom.meek.exu.BranchDecode)
