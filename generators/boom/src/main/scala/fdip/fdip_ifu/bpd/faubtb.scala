...
import boom.fdip.util.{BoomCoreStringPrefix, WrapInc}
...
class FAMicroBTBBranchPredictorBank(params: BoomFAMicroBTBParams = BoomFAMicroBTBParams())(implicit p: Parameters) extends AbstractBranchPredictor()(p)
{
