...
import boom.fdip.util.{BoomCoreStringPrefix, MaskLower, WrapInc}
...
class TageBranchPredictorBank(params: BoomTageParams = BoomTageParams())(implicit p: Parameters) extends AbstractBranchPredictor()(p)
{
