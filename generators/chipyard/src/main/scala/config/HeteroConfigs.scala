...
class OurHeterSoCConfig extends Config(
  new barf.WithHellaCachePrefetcher(Seq(5), barf.VecRunaheadParams()) ++   // strided prefetcher, sits in front of the L1D$, monitors core requests to prefetching into the L1D$
