...
# dromajo modifications # Voyager-add
# CONDA_PREFIX = $(chipyard_dir)/.conda-env 
# DROMAJO_LIB_DIR ?= $(CONDA_PREFIX)/lib
# DROMAJO_INCLUDE_DIR ?= $(CONDA_PREFIX)/include
DROMAJO_LIB_DIR ?= $(chipyard_dir)/.conda-env/lib
DROMAJO_INCLUDE_DIR ?= $(chipyard_dir)/.conda-env/include
